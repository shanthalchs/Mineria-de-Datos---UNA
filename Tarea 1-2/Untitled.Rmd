...
B <- matrix(c(9,1,4,3,3,12,4,-1,-2),nrow = 3,ncol = 3)
...
18. Crear un Data Frame con diez alumnos con su edad, año de nacimiento y número de teléfono. Deberá aparecer el nombre de la columna (edad, año de nacimiento, teléfono) y el nombre de la fila, que será el nombre del alumno al que corresponden los datos.

```{r}
alumnos <- data.frame(edad = c(8,8,9,9,9,8,9,9,10,8),
           añoNac = c(2011,2011,2011,2011,2011,2011,2011,2011,2010,2011),
